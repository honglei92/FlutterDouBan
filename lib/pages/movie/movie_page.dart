...
class _MoviePageState extends State<MoviePage>  with AutomaticKeepAliveClientMixin {
  ...
  Widget _getComingSoonItem(Subject comingSoonBean, var itemW) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        RouterDouB.push(context, RouterDouB.detailPage, comingSoonBean.id);
      },
    );
  }
  ...
  Widget _getHotMovieItem(Subject hotMovieBean, var itemW) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        RouterDouB.push(context, RouterDouB.detailPage, hotMovieBean.id);
      },
    );
  }
      ...
      child: CustomScrollView(
        ...
        slivers: <Widget>[
          ...
          getCommonImg(Constant.IMG_TMP1, (){
            RouterDouB.pushNoParams(context, "http://www.flutterall.com");
          }),
          SliverToBoxAdapter(
            child: Padding(
